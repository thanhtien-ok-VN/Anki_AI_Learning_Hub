...
- **Model resolution:** `auto` → tự động áp dụng chuỗi Waterfall 6 cấp (`gemini-3.5-flash-lite` ➔ `gemini-flash-lite-latest` ➔ `gemini-3.5-flash` ➔ `gemini-3.6-flash` ➔ `gemini-3.1-flash-lite` ➔ `gemini-3-flash-preview`)
